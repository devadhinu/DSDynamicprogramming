...
public class MergeListRecursion {
	...
	public Node mergeLists_Recursive(Node list1, Node list2)
	{

		Node head = new Node();
		Node tail = head;
		recursion(list1,list2,head,tail);
		return head.next;
				
	}
	private Node recursion(Node list1, Node list2,Node head,Node tail)
	{
	...
	//	printVals(tail);
		...
		return recursion(list1,list2,head,tail);
	}
